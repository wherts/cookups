...
public class DateMatcherTest {
  ...
  public void initialize() {
    // MAKE MEN
    gayMan1 = new Suitor.Builder(new User("gayMan1", "gm1",
        null)).setGender(-100)
        .setGay().build();
    gayMan2 =
        new Suitor.Builder(new User("gayMan2", "gm2", null)).setGender(-1)
            .setGay().build();
    straightMan1 = new Suitor.Builder(new User("straightMan1", "sm1",
        null)).setGender(-100)
        .setStraight().build();
    straightMan2 = new Suitor.Builder(new User("straightMan2", "sm2",
        null)).setGender(-1)
        .setStraight().build();
    biMan1 =
        new Suitor.Builder(new User("biMan1", "bm1", null)).setGender(-100)
            .setBi().build();
    biMan2 = new Suitor.Builder(new User("biMan2", "bm2", null)).setGender(-1)
        .setBi().build();
    queerMan1 = new Suitor.Builder(new User("queerMan1", "qm1",
        null)).setGender(-100).build();
    queerMan2 = new Suitor.Builder(new User("queerMan2", "qm2",
        null)).setGender(-1).build();

    // MAKE WOMEN
    gayWoman1 = new Suitor.Builder(new User("gayWoman1", "gw1",
        null)).setGender(100)
        .setGay().build();
    gayWoman2 = new Suitor.Builder(new User("gayWoman2", "gw2",
        null)).setGender(1)
        .setGay().build();
    straightWoman1 = new Suitor.Builder(new User("straightWoman1", "sw1",
        null)).setGender(100)
        .setStraight().build();
    straightWoman2 = new Suitor.Builder(new User("straightWoman2", "sw2",
        null)).setGender(1)
        .setStraight().build();
    biWoman1 = new Suitor.Builder(new User("biWoman1", "bw1",
        null)).setGender(100)
        .setBi().build();
    biWoman2 =
        new Suitor.Builder(new User("biWoman2", "bw2", null)).setGender(1)
            .setBi().build();
    queerWoman1 = new Suitor.Builder(new User("queerWoman1", "qw1",
        null)).setGender(100).build();
    queerWoman2 = new Suitor.Builder(new User("queerWoman2", "qw2",
        null)).setGender(1).build();
  }
  ...
  public void builderTest() {
    ...
    Suitor s2 =
        new Suitor.Builder(new User("Nothing", "nothing", null)).build();
    assertFalse(s2.isBi());
