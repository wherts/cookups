...
public class DateRankingTest {
  ...
  public void gayTest() {
    ...
    Suitor biWoman2 = new Suitor.Builder(new User("biWoman2", "bw2", null)).setGender(70)
        .setBi().build();
    Suitor biWoman3 = new Suitor.Builder(new User("biWoman3", "bw3", null)).setGender(10)
        .setBi().build();
    ...
    Suitor biMan1 = new Suitor.Builder(new User("biMan1", "bm1", null))
        .setGender(-100).setBi().build();
    Suitor biMan2 = new Suitor.Builder(new User("biMan2", "bm2", null)).setGender(-70)
        .setBi().build();
    Suitor biMan3 = new Suitor.Builder(new User("biMan3", "bm3", null)).setGender(-10)
        .setBi().build();
...
//      System.out.println(match.person().name() + ": " + (gayMan.sexAppeal(match)+ match.sexAppeal(gayMan)));
//    }
