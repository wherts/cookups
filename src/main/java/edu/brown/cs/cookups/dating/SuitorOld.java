...
public class SuitorOld {
  ...
  public static class Builder {
    ...
    public SuitorOld build() {
      this.queer = !(this.gay || this.straight || this.bi);
      return new SuitorOld(this);
    }
  }

  private SuitorOld(Builder b) {
    this.gay = b.gay;
  ...
  public int compatability(SuitorOld suitor) {
    return oneWayCompatability(suitor, this) + oneWayCompatability(this, suitor);
  }
  
  public int oneWayCompatability(SuitorOld suitor1, SuitorOld suitor2) {
    int compatability = 0;
  ...
  public boolean equals(Object o) {
    if (o == null) {
      ...
      return true;
    } else if (!(o instanceof SuitorOld)) {
      return false;
    }
    return person.id().equals(((SuitorOld) o).person().id());
  }
}
